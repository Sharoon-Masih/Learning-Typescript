...
//example of let
let firstName: string; //declaration 
...
// example of Var:
var number1: number = 100; //initialization
...
let myProfession = "Software Engineer"; //here we are not doing type annotation and it is also known as "implicitly typing".
...
if (test) {
    let Check: string = "done"; //we are initializing the 'Check' variable using the 'let' keyword inside block.
}
else {
...
let age: number = 30; //initialization
...
if (test2) {
    var Check2: string = "done"; //we are initializing the 'Check' variable using the 'let' keyword inside block.
}
...
let num=40
let Name="shah";
let msg=Name+num //type coersion
